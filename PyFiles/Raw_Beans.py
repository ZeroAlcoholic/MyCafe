...
FullCoffeeList=FullCoffeeList[-46:]
CoffeeList = CoffeeList[-46:]
...
class OptionCoffee1(Demo):
   ...
   def __init__(self, master):
      ...
      f = Frame(self)
      Label(f, text='Amount : ').pack(side=LEFT)
      op = OptionMenu(f, app.RoastR1, '1/3', '0.5', '2/3', '1.0')
      Label(f, text=' kg').pack(side=RIGHT)
      op.pack()
      f.pack()
      ...
      op = OptionMenu(f, app.AmountA1_1, *range(10))
...
class OptionCoffee2(Demo):
   ...
   def __init__(self, master):
      ...
      f = Frame(self)
      Label(f, text='Amount : ').pack(side=LEFT)
      op = OptionMenu(f, app.RoastR2, '1/3', '0.5', '2/3', '1.0')
      Label(f, text=' kg').pack(side=RIGHT)
      op.pack()
      f.pack()
      ...
      f = Frame(self)
      Label(f, text='Amount Number :').pack(side=LEFT)
      op = OptionMenu(f, app.AmountA2, *range(10))
      #op1 = OptionMenu(f, app.AmountA1_2, *range(10))
      op.pack(side=LEFT)
      #op1.pack(side=RIGHT)
      f.pack()
...
class OptionCoffee3(Demo):
   ...
   def __init__(self, master):
      ...
      f = Frame(self)
      Label(f, text='Amount : ').pack(side=LEFT)
      op = OptionMenu(f, app.RoastR3, '1/3', '0.5', '2/3', '1.0')
      Label(f, text=' kg').pack(side=RIGHT)
      op.pack()
      f.pack()
      ...
      f = Frame(self)
      Label(f, text='Amount Number :').pack(side=LEFT)
      op = OptionMenu(f, app.AmountA3, *range(10))
      #op1 = OptionMenu(f, app.AmountA1_2, *range(10))
      op.pack(side=LEFT)
      #op1.pack(side=RIGHT)
      f.pack()
...
class OptionCoffee4(Demo):
   ...
   def __init__(self, master):
      ...
      f = Frame(self)
      Label(f, text='Amount : ').pack(side=LEFT)
      op = OptionMenu(f, app.RoastR4, '1/3', '0.5', '2/3', '1.0')
      Label(f, text=' kg').pack(side=RIGHT)
      op.pack()
      f.pack()
      ...
      f = Frame(self)
      Label(f, text='Amount Number :').pack(side=LEFT)
      op = OptionMenu(f, app.AmountA4, *range(10))
      #op1 = OptionMenu(f, app.AmountA1_2, *range(10))
      op.pack(side=LEFT)
      #op1.pack(side=RIGHT)
      f.pack()
...
class OptionCoffee5(Demo):
   ...
   def __init__(self, master):
      ...
      f = Frame(self)
      Label(f, text='Amount : ').pack(side=LEFT)
      op = OptionMenu(f, app.RoastR5, '1/3', '0.5', '2/3', '1.0')
      Label(f, text=' kg').pack(side=RIGHT)
      op.pack()
      f.pack()
      ...
      f = Frame(self)
      Label(f, text='Amount Number :').pack(side=LEFT)
      op = OptionMenu(f, app.AmountA5, *range(10))
      #op1 = OptionMenu(f, app.AmountA1_2, *range(10))
      op.pack(side=LEFT)
      #op1.pack(side=RIGHT)
      f.pack()
...
class OptionCoffee6(Demo):
   ...
   def __init__(self, master):
      ...
      f = Frame(self)
      Label(f, text='Amount : ').pack(side=LEFT)
      op = OptionMenu(f, app.RoastR6, '1/3', '0.5', '2/3', '1.0')
      Label(f, text=' kg').pack(side=RIGHT)
      op.pack()
      f.pack()
      ...
      f = Frame(self)
      Label(f, text='Amount Number :').pack(side=LEFT)
      op = OptionMenu(f, app.AmountA6, *range(10))
      #op1 = OptionMenu(f, app.AmountA1_2, *range(10))
      op.pack(side=LEFT)
      #op1.pack(side=RIGHT)
      f.pack()
...
class RadiobuttonCoffee1(Demo):
   ...
   def __init__(self, master):
      Demo.__init__(self, master)
      Radiobutton(self, text='DripSelling',
...
#---------------------------------------Coffee 01------------------------------------------
      ...
      self.RoastR1 = StringVar();         self.RoastR1.set('1.0')
      self.DateD1 = StringVar();      self.DateD1.set(Todaystr)
      self.AmountA1_1 = IntVar();    self.AmountA1_2 = IntVar();
      self.AmountA1_1.set(0);    self.AmountA1_2.set(0);
      

      self.TypeVar2 = IntVar();  self.TypeVar2.set('1')
#---------------------------------------Coffee 02------------------------------------------
      self.CoffeeC2 = StringVar();      self.CoffeeC2.set(DEFAULT_OPTION)
      self.RoastR2 = StringVar();         self.RoastR2.set('1.0')
...
#---------------------------------------Coffee 03------------------------------------------
      ...
      self.RoastR3 = StringVar();         self.RoastR3.set('1.0')
...
#---------------------------------------Coffee 04------------------------------------------
      ...
      self.RoastR4 = StringVar();         self.RoastR4.set('1.0')
...
#---------------------------------------Coffee 05------------------------------------------
      ...
      self.RoastR5 = StringVar();         self.RoastR5.set('1.0')
...
#---------------------------------------Coffee 06------------------------------------------
      ...
      self.RoastR6 = StringVar();         self.RoastR6.set('1.0')
...
#----------------------------------------------------------------
    ...
    RoastR1 =  app.RoastR1.get()+' kg'
    temp1 = app.DateD1.get()
    AmountA1 = app.AmountA1_1.get()
...
TexAll = [(156,170),(171,185),(191,205),(206,220),(226,240),(241,255),
          (261,275),(276,290),(296,310),(311,325),(331,345),(346,360),
          (366,380),(381,395),(401,415),(416,430),(436,450),(451,465),
          (471,485),(486,500),(506,520),(521,535),(541,555),(556,570)]#541	555	556	570,  (51,65),(66,80),(86,100),(101,115),(121,135),(136,150),
TexNames = [159,174,194,209,229,244,264,279,299,314,334,349,369,384,404,419,439,454,474,489,509,524,544,559]#54,69,89,104,124,139,
TexDates = [162,177,197,212,232,247,267,282,302,317,337,352,372,387,407,422,442,457,477,492,512,527,547,562]#57,72,92,107,127,142,
TexRoasting = [167,182,202,217,237,252,272,287,307,322,342,357,377,392,412,427,447,462,482,497,517,532,552,567]#62,77,97,112,132,147,

#filew = open('Testing.tex','w')
#filew.write(codecs.BOM_UTF8)
filew = codecs.open("RawBeans.tex", "w", "utf-8")
...
fileType2.close()
#
fileorig = codecs.open("DripForSmall.tex", "r", "utf-8")
...
if TypeT6 ==2 :
    ...
    TEMP[7] = str(FullCoffeeList[Tidx][5])+TEMP[7] #Location中文
    TEMP[10] = FullCoffeeList[Tidx][6]+', '+FullCoffeeList[Tidx][8] +FullCoffeeList[Tidx][9]+ TEMP[10] #Location英文
    TEMP[13] =str(DateD6) + TEMP[13]
    if len(RoastR6) > 3:
        TEMP[19] = '4'+TEMP[19]
        TEMP[22] = '\small '+RoastR6   + TEMP[22]
    ...
    Tidx = CoffeeList.index(CoffeeC6  )
    print(Tidx)
    if len(FullCoffeeList[Tidx][14]) > 75:
        if FullCoffeeList[Tidx][14].find('、',35) != -1 & FullCoffeeList[Tidx][14].find('，',35) != -1:
            tdiv = min(FullCoffeeList[Tidx][14].find('、',35)+3,FullCoffeeList[Tidx][14].find('，',35)+3)
        else:
            tdiv = FullCoffeeList[Tidx][14].find('、',35)+3
        FullCoffeeList[Tidx][14] = str('\scriptsize '+FullCoffeeList[Tidx][14][:tdiv]+'  \\vspace*{-0.375em} \\\\  '+'\scriptsize '+FullCoffeeList[Tidx][14][tdiv:])
        print(FullCoffeeList[Tidx][14])                       
    else:
        FullCoffeeList[Tidx][14] = str('\\footnotesize '+FullCoffeeList[Tidx][14])
    for using in range(AmountA1*TypeT1+AmountA2*TypeT2+AmountA3*TypeT3+AmountA4*TypeT4+AmountA5*TypeT5,AmountA1*TypeT1+AmountA2*TypeT2+AmountA3*TypeT3+AmountA4*TypeT4+AmountA5*TypeT5+AmountA6*TypeT6):
        lines[TexNames[using]-1]=str(FullCoffeeList[Tidx][0][1:]+' '+FullCoffeeList[Tidx][1][:-1]+',  \$'+str(int(FullCoffeeList[Tidx][2])-2)+'+2/per KG'+' \\vspace*{-0.2em} \\\\ ') + lines[TexNames[using]-1]
        lines[TexDates[using]-1]=str(FullCoffeeList[Tidx][7]+' '+FullCoffeeList[Tidx][9]+FullCoffeeList[Tidx][11]+FullCoffeeList[Tidx][13]+' \\vspace*{-0.12em} \\\\ '+FullCoffeeList[Tidx][8]+' '+FullCoffeeList[Tidx][10])+lines[TexDates[using]-1]+' \\vspace*{-0.22em} \\\\ '
        lines[TexRoasting[using]-1]=str(FullCoffeeList[Tidx][14])+lines[TexRoasting[using]-1]
...
if TypeT1 == 2 :
    ...
    TEMP[1] = str(FullCoffeeList[Tidx][3]+' ') +TEMP[1]#Country中文   TEMP[7] = str(FullCoffeeList[Tidx][5])+TEMP[7] #Location中文
    TEMP[10] = FullCoffeeList[Tidx][6]+', '+FullCoffeeList[Tidx][8] +FullCoffeeList[Tidx][9]+ TEMP[10] #Location英文
    TEMP[13] =str(DateD1) + TEMP[13]

    if len(RoastR1) > 3:
        TEMP[19] = '4'+TEMP[19]
        TEMP[22] = '\small '+RoastR1   + TEMP[22]
        TEMP[23] = TEMP[23].replace("normalsize","small")
    elif len(RoastR1) == 3:
    ...
    Tidx = CoffeeList.index(CoffeeC1  )
    #print len(FullCoffeeList[Tidx][14]), (FullCoffeeList[Tidx][14])
    if len(FullCoffeeList[Tidx][14]) > 75:
        if FullCoffeeList[Tidx][14].find('、',35) != -1 & FullCoffeeList[Tidx][14].find('，',35) != -1:
            tdiv = min(FullCoffeeList[Tidx][14].find('、',35)+3,FullCoffeeList[Tidx][14].find('，',35)+3)
        else:
